...
This document describes the next-generation agentic system for Grais, leveraging OpenAI Agents SDK. It is written for future maintainers and AI models, providing deep context, rationale, and design decisions to ensure continuity and extensibility.
